...
energy['Country'] = energy['Country'].apply(cleanse)
name_changes = {"Republic of Korea":"South Korea",
     "United States of America":"United States",
     "United Kingdom of Great Britain and Northern Ireland":"United Kingdom",
     "China, Hong Kong Special Administrative Region":"Hong Kong"}
energy.replace({"Country":name_changes}, inplace=True)
...
name_changes = {"Korea, Rep.": "South Korea",
     "Iran, Islamic Rep.": "Iran",
     "Hong Kong SAR, China": "Hong Kong"}
GDP.replace({"Country":name_changes}, inplace = True)
...
df = df[['Rank','Documents','Citable documents','Citations',
...
def answer_two():
    ...
    # union of a,b,c - intersection of a,b,c
...
def answer_six():
    Top15 = answer_one()
    country_percent = Top15.sort_values(by = '% Renewable',ascending=False).iloc[0]
    return (country_percent.name,country_percent['% Renewable'])
